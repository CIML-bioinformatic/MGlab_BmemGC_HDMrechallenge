...
ANALYSIS_STEP_NAME = "06a_LN_GlobalHeterogeneity_NoT_NoVariableIG_NoHeavyChain"
...
PATH_RDS_SEURAT_OBJECT = file.path( PATH_EXPERIMENT_OUTPUT, 
                                    ...
                                    "AIDYFP_BmemGC_PC_Day0and7_HDMrechallenge_230321_VH00228_159_AACKKJ7M5_seuratObject_subset_LN.RDS")
