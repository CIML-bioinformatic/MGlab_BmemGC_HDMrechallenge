...
read_chunk( path=file.path( WORKING_DIR, "02_IgEvsOthers.R"));
...
# Ighe vs Igs expression

```{r rmd_ighe_vs_others_total, fig.dim = c(7,7), out.width = "25%"}
<<ighe_vs_others_total>>
```


# Ighe vs Igs by HTO {.tabset .tabset-fade}

```{r rmd_ighe_vs_others_byHTO, fig.dim = c(12, 8)}
<<ighe_vs_others_byHTO>>
```
