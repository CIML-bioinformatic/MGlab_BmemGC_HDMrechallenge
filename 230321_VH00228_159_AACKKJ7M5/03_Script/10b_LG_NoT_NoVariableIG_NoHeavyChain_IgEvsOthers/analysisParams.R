...
ANALYSIS_STEP_NAME = "10b_LG_NoT_NoVariableIG_NoHeavyChain_IgEvsOthers"
...
# List of genes expression to compare against 'Ighe' (grep against real names)
IgGenesSelectionBase = c("Ighd", "Ighm", "Igha", "Ighg1", "Ighg2", "Ighg3")
...
FILE_FILTER_CELLS = file.path(PATH_EXPERIMENT_REFERENCE,
                              "02_Analyses",
                              "06_CellsSelections",
                              "01_TCellls",
                              "DemuxClusteringRes0.6_Cluster8.tsv")
...
MONITORED_GENES = c( GENES_SERGIO)
...
MODULES_GENES = c(MODULES_GENES, GENES_SERGIO)
