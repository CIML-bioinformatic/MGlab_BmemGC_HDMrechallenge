...
ANALYSIS_STEP_NAME = "14a_LN_NoT_NoVariableIG_NoHeavyChain_namedClusters"
...
ORDER_CLUSTER = NULL # c( "B mem 1", "Activated/GC", "Plasma PC2", "GC", "Proliferating", "Plasma PC3", "Plasma PC1", "B mem 2")
