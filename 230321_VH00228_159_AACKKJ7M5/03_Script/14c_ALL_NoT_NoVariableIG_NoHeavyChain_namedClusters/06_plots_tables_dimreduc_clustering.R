...
# ..............................................................................
## @knitr chisquare_test_clusters_Tissue
...
# ..............................................................................
if(ncol(clustersCountByTissue)>1)
{
  chisq = chisq.test(clustersCountByTissue)
  ...
  # Show the expected counts considering margins statistics, to contrast with
  # observed counts shown above
  print( knitr::kable( addmargins(round(chisq[["observed"]],2)),
                       align   = "c",
                       caption = "Observed number of cells by population (Cluster) and tissue from X².")) #%>% kable_styling(bootstrap_options = c("condensed"), full_width = FALSE);
  ...
  #mosaicplot(clustersCountByTissue, shade = TRUE, las = 2, main = "X² residuals", xlab="", ylab="")
} else
{
  cat("Single column/identity : skipping Chi² computation")
}


# ..............................................................................
## @knitr chisquare_test_clusters_Tissue_M456
# Test independance between rows and columns (clusters and sample condition/HTO)
# to detect counts over expected values under random condition.
# ..............................................................................
if(ncol(clustersCountByTissue_M456)>1)
{
  chisq = chisq.test(clustersCountByTissue_M456)
  
  # Show the expected counts considering margins statistics, to contrast with
  # observed counts shown above
  print( knitr::kable( addmargins(round(chisq[["expected"]],2)),
                       align   = "c",
                       caption = "Expected number of cells by population (Cluster) and tissue from X².\nTo compare with observed counts.")) #%>% kable_styling(bootstrap_options = c("condensed"), full_width = FALSE);
...
## @knitr cellCycle_dimreduc

sc10x = CellCycleScoring(sc10x, 
                         s.features = CELL_CYCLE_SPHASE_GENELIST, 
                         g2m.features = CELL_CYCLE_G2MPHASE_GENELIST, 
                         set.ident = FALSE)

print(DimPlot(sc10x, group.by = "Phase"))

## @knitr cellCycle_table

print( knitr::kable( addmargins(table(sc10x[["Phase", drop = TRUE]], Idents(sc10x))),
                     align   = "c",
                     caption = "Number of cells by population (Cluster) and condition (HTO)")) #%>% kable_styling(bootstrap_options = c("condensed"), full_width = FALSE);
