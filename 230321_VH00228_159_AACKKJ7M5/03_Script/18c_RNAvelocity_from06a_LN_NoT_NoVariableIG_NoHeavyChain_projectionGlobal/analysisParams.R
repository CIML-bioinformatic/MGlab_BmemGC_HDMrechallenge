...
# R part no re-executed here, but python will use path from previous output to get H5ad file
ANALYSIS_STEP_NAME = "09c_RNAvelocity_from06a_LN_NoT_NoVariableIG_NoHeavyChain"
PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "scVelo"
